...
import DashboardEditarJornadaSocial from './pages/dashboard/jornadas-sociales/edit/page'
import DashboardNuevaJornadaSocial from './pages/dashboard/jornadas-sociales/nuevo/page'
import DashboardJornadasSocilaes from './pages/dashboard/jornadas-sociales/page'
...
import DashboardJornadasSocialCitas from './pages/dashboard/jornadas-sociales/citas/page'
	...
	return (
		<BrowserRouter>
			...
			<Routes>
				...
				<Route path="/register" element={<PublicRoute element={<h1>Register</h1>} />} />

				{/* Rutas protegidas */}
				<Route
					path="/dashboard"
					element={<ProtectedRoute allowedRoles={all} element={<DashboardIndex />} />}
				/>
				<Route
					path="/dashboard/invitaciones"
					element={
						<ProtectedRoute allowedRoles={all} element={<DashboardInvitaciones />} />
					}
				/>
				...
				<Route
					...
					element={<ProtectedRoute allowedRoles={all} element={<DashboardEventos />} />}
				/>
				<Route
					path="/dashboard/nuevo-evento"
					element={
						<ProtectedRoute allowedRoles={all} element={<DashboardNuevoEvento />} />
					}
				/>
				<Route
					path="/dashboard/editar-evento/:id"
					element={
						<ProtectedRoute allowedRoles={all} element={<DashboardEditarEvento />} />
					}
				/>
				<Route
					path="/dashboard/eventos/:id"
					element={
						<ProtectedRoute allowedRoles={all} element={<DashboardEventoDetail />} />
					}
				/>
				<Route
				...
				<Route
					...
					element={
						<ProtectedRoute allowedRoles={all} element={<DashboardTipoLugares />} />
					}
				/>
				<Route
					path="/dashboard/nuevo-tipo-lugar"
					element={
						<ProtectedRoute allowedRoles={all} element={<DashboardNuevoTipoLugar />} />
					}
				/>
				<Route
					path="/dashboard/editar-tipo-lugar/:id"
					element={
						<ProtectedRoute allowedRoles={all} element={<DashboardEditarTipoLugar />} />
					}
				/>

				<Route
					path="/dashboard/grupos"
					element={<ProtectedRoute allowedRoles={all} element={<DashboardGrupos />} />}
				/>
				<Route
					path="/dashboard/nuevo-grupo"
					element={
						<ProtectedRoute allowedRoles={all} element={<DashboardNuevoGrupo />} />
					}
				/>
				<Route
					path="/dashboard/editar-grupo/:id"
					element={
						<ProtectedRoute allowedRoles={all} element={<DashboardEditarGrupo />} />
					}
				/>
				<Route
				...
				<Route
					...
					element={<ProtectedRoute allowedRoles={all} element={<DashboardProgramas />} />}
				/>
				<Route
					path="/dashboard/nuevo-programa"
					element={
						<ProtectedRoute allowedRoles={all} element={<DashboardNuevoPrograma />} />
					}
				/>
				<Route
					path="/dashboard/editar-programa/:id"
					element={
						<ProtectedRoute allowedRoles={all} element={<DashboardEditarPrograma />} />
					}
				/>
				...
				<Route
					...
					element={
						<ProtectedRoute allowedRoles={all} element={<DashboardTipoEventos />} />
					}
				/>
				<Route
					path="/dashboard/nuevo-tipo-evento"
					element={
						<ProtectedRoute allowedRoles={all} element={<DashboardNuevoTipoEvento />} />
					}
				/>
				<Route
					path="/dashboard/editar-tipo-evento/:id"
					element={
						<ProtectedRoute allowedRoles={all} element={<DashboardEditarTipoEvento />} />
					}
				/>
				...
				<Route
					...
					element={
						<ProtectedRoute allowedRoles={all} element={<DashboardEjeTematicos />} />
					}
				/>
				<Route
					path="/dashboard/nuevo-eje-tematico"
					element={
						<ProtectedRoute allowedRoles={all} element={<DashboardNuevoEjeTematico />} />
					}
				/>
				<Route
					path="/dashboard/editar-eje-tematico/:id"
					element={
						<ProtectedRoute allowedRoles={all} element={<DashboardEditarEjeTematico />} />
					}
				/>

				<Route
					path="/dashboard/cargos"
					element={<ProtectedRoute allowedRoles={all} element={<DashboardCargos />} />}
				/>
				<Route
					path="/dashboard/nuevo-cargo"
					element={
						<ProtectedRoute allowedRoles={all} element={<DashboardNuevoCargo />} />
					}
				/>
				<Route
					path="/dashboard/editar-cargo/:id"
					element={
						<ProtectedRoute allowedRoles={all} element={<DashboardEditarCargo />} />
					}
				/>
				<Route
					path="/dashboard/galeria"
					element={<ProtectedRoute allowedRoles={all} element={<DashboardGaleria />} />}
				/>
				<Route
					path="/dashboard/nueva-foto"
					element={<ProtectedRoute allowedRoles={all} element={<DashboardNuevaFoto />} />}
				/>
				...
				<Route
					path="/dashboard/jornadas-sociales"
					element={
						<ProtectedRoute
							allowedRoles={[Perfil.Administrador]}
							element={<DashboardJornadasSocilaes />}
						/>
					}
				/>

				<Route
					path="/dashboard/editar-jornada-social/:id"
					element={
						<ProtectedRoute
							allowedRoles={[Perfil.Administrador]}
							element={<DashboardEditarJornadaSocial />}
						/>
					}
				/>

				<Route
					path="/dashboard/nueva-jornada-social"
					element={
						<ProtectedRoute
							allowedRoles={[Perfil.Administrador]}
							element={<DashboardNuevaJornadaSocial />}
						/>
					}
				/>
				<Route
					path="/dashboard/jornada-social/citas/:folio"
					element={
						<ProtectedRoute
							allowedRoles={[Perfil.Administrador]}
							element={<DashboardJornadasSocialCitas />}
						/>
					}
				/>
