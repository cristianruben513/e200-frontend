...
export default function FiltroPromotor({
	...
	return (
		<div>
			<label htmlFor="promotor-select" className="block text-sm font-medium text-gray-700">
			...
			<select
				...
				onChange={(e) => {
					...
					const selectedPromotor = promotores.find((promotor) => promotor.id === selectedId) || null
